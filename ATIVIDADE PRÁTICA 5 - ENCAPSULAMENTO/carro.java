...
public class Carro {
    ...
    public double calcularValorTanque(double precoGasolina) {
        return capacidadeTanque * precoGasolina;
    }

    public void ligar() { System.out.println("O carro está ligado!"); }
    public void acelerar() { System.out.println("O carro está acelerando!"); }
}